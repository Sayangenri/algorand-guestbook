...
By default the template creates a single `HelloWorld` contract under guestbook_app_contract folder in the `smart_contracts` directory. To add a new contract:
